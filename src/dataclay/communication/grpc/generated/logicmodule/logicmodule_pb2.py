...
_LOGICMODULE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='dataclay.communication.grpc.logicmodule.LogicModule.batchObjectInfo',
    index=71,
    containing_service=None,
    input_type=dataclay_dot_communication_dot_grpc_dot_messages_dot_logicmodule_dot_logicmodule__messages__pb2._BATCHOBJECTINFOREQUEST,
    output_type=dataclay_dot_communication_dot_grpc_dot_messages_dot_logicmodule_dot_logicmodule__messages__pb2._BATCHOBJECTINFORESPONSE,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='setDataSetID',
